...
hl.bind(mod .. " + J", function()
	hl.dispatch(current_layout == "master" and hl.dsp.layout("cyclenext") or hl.dsp.window.cycle_next())
end)
hl.bind(mod .. " + K", function()
	hl.dispatch(current_layout == "master" and hl.dsp.layout("cycleprev") or hl.dsp.window.cycle_next({ prev = true }))
end)
...
for i = 1, 5 do
	...
	hl.bind(mod .. " + " .. workspace, split and split.workspace(workspace) or hl.dsp.focus({ workspace = workspace }))
	hl.bind(
		mod .. " + SHIFT + " .. workspace,
		split and split.move_to_workspace_silent(workspace) or hl.dsp.window.move({ workspace = workspace })
	)
end
