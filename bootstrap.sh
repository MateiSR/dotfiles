...
cp -n .config/dotfiles/machine.lua.example "$HOME/.config/dotfiles/machine.lua"
cp -n .config/dotfiles/git.conf.example "$HOME/.config/dotfiles/git.conf"
cp -n .config/dotfiles/scripts/gs_zipline_conf_example.sh "$HOME/.config/dotfiles/scripts/gs_zipline_conf.sh"
cp -n .config/waypaper/config.ini.example "$HOME/.config/waypaper/config.ini"
